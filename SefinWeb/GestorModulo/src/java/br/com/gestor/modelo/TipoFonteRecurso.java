 ...
 */
@Entity
@Table(name = "TIPOFONTERECURSO", catalog = "", schema = "")
public class TipoFonteRecurso implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Column(name = "TIPCOD", nullable = false)
    private String id;
    @Length(max = 100)
    @Column(name = "TIPNOME", nullable = false, length = 100)
    private String nome;
    ...
    public String toString() {
        return "TipoFonteRecurso{" + "id=" + id + ", nome=" + nome + '}';
    }
}
